...
#
# Original image : https://hub.docker.com/r/jrottenberg/ffmpeg/
# - By Julien Rottenberg
# Updated with the following :
# - Use last version of OpenJPEG (threading improvements)
# - Patch OpenJPEG and FFmpeg to correctly interpret cinema JPEG2000 as XYZ
#
...
RUN \
        ...
        tar -zx --strip-components=1 && \
        git apply /tmp/workdir/0001-Extract-RSIZ-on-decoding.patch && \
...
RUN \
        DIR=/tmp/ffmpeg && mkdir -p ${DIR} && cd ${DIR} && \
        git apply /tmp/workdir/0001-Interpret-cinema-profiles-as-XYZ.patch && \
        ./configure \
        --disable-debug \
        --disable-doc \
        --disable-ffplay \
...
MAINTAINER  Rémi Achard <remiachard@gmail.com>
